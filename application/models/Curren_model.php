...
class Curren_model extends CI_Model {
	...
	public function add_currency(){
		...
		$data = array(
			'currency_date' => $this->input->post('curr_date'),
			'currency_from' => $this->input->post('curr_from'),
			'currency_to' => $this->input->post('curr_to'),
			'currency_rate' => $this->input->post('curr_rate'),
	...
	public function get_currency($order=NULL,$limit=NULL){
	...
	public function get_currency_avg(){
